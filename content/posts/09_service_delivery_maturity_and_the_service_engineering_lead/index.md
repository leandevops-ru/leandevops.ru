...
draft: true
---
# 9. Зрелость предоставления услуг и лидерство в области разработки как сервиса
Если вы не можете увидеть куда направляетесь --- спросите того, кто побывал там
раньше вас.
...
(описанные в предыдущей главе), необходимые им для достижения своих результатов.
Многие команды по предоставлению услуг изо всех сил пытаются достичь зрелости,
чтобы последовательно и уверенно предоставлять эти <<возможности>>. Растущая
сложность экосистемы только увеличивает трудности ее достижения. По мере роста
размера и количества команд, инстансов и структур даже, казалось бы, отличным
командам может быть трудно поддерживать общую осведомленность и
межорганизационную согласованность.

К сожалению, появляющиеся инструменты и подходы к разработке в основном
по-прежнему направлены на устранение трудностей при разработке. В результате они
часто вносят незначительный вклад в обеспечение достаточного потока информации,
необходимого для того, чтобы оставаться в курсе взаимодействий в экосистеме,
которые формируют <<возможности>> предоставления услуг. Это означает, что
небольшие пробелы и перекосы свободно распространяются по экосистеме, часто
незаметно искажая нашу задуманную модель  динамики разработки таким образом, что
в конечном итоге подрывает эффективность принятия нами решений.

Лучший способ для вас и вашей команды преодолеть эту проблему --- начать
оценивать зрелость практик и моделей поведения, на которые вы полагаетесь,
...
могут помочь вам начать процесс разработки и вывести на правильный путь
...
вашей экосистемы разработки, которые влияют на вашу способность предоставлять
свои услуги с ожидаемыми <<качествами>>. Фреймворк основан на концепциях
узнаваемости, описанных в предыдущей главе, и придерживается многих разумных
подходов к гигиене, архитектуре и совместной работе, которые позволяют командам
...
осведомленности требуется нечто большее, чем несколько настроек процесса и
инструментов. Иногда у членов команды такие высокие нагрузки по работе, что они
постоянно подвергаются риску развития <<туннельного видения>>, которое затемняет
важнейшие взаимосвязи между их областью и экосистемой в целом. В других случаях
потребность в актуальной, глубоко технической, информации настолько высока из-за
быстрой и сложной динамики экосистемы, что она не может быть полностью
удовлетворена даже самым увлеченным и исполненным благих намерений, менеджером,
архитектором или руководителем проекта /программы.

Такие проблемы --- вот где уместна вторая часть. Это вращающийся механизм,
который может более непосредственно помочь повысить осведомленность и
согласованность команды. В зависимости от того, насколько сложна и
фрагментирована ваша экосистема, а также от того, какими возможностями обладает
ваша команда для улучшения, она может использоваться как на временной, так и на
более постоянной основе. Мне нравится называть этот механизм *Service
Engineering Lead*, или сокращенно *SE Lead*.

В этой главе будет рассказано о том, что это за механизмы, как они работают, и о
некоторых идеях относительно того, как их можно внедрить в вашей организации.

## Моделирование зрелости предоставления услуг

Наша отрасль изобилует всевозможными зрелыми моделями. Так многие из них --- не
более чем уловки для продажи консалтинговых услуг, что даже упоминание концепции
может вызвать недовольство у членов команды. Однако есть некоторые области, где
хорошо структурированная модель может быть эффективным способом измерения и
направления организации к более предсказуемому, надежному и результативному
предоставлению возможностей и услуг, необходимых для удовлетворения их клиентов.

Это может показаться очевидным, но один из лучших способов определить, поможет
ли данная зрелая модель --- это посмотреть на то, что измеряется. Полезная
модель должна научить вас, как выявлять, а затем либо смягчать, либо устранять
коренные причины любой непредсказуемости и рисков, от которых страдает ваша
организация. Это отличается от более несовершенных зрелых моделей, которые, как
правило, фокусируются на подсчете результатов, которые в лучшем случае выявляют
только симптомы, а не их первопричины.

Прелесть зрелой модели заключается в том, что, в отличие от школьной оценки, вам
не обязательно иметь идеальный балл по всем параметрам, чтобы получить наиболее
практичный для вас уровень зрелости. Вы можете столкнуться с ситуациями,
подобными моей, когда некоторая незрелость и изменчивость в какой-либо области
вполне приемлемы, если известны их причины и диапазон, и они никогда не влияют
на <<возможности>>, от которых зависят клиенты.

На самом деле, любая модель зрелости, которая настаивает на том, что успех
приходит только тогда, когда все показатели идеальны, изначально не верна. Я
регулярно сталкиваюсь с организациями, которые, похоже, стремятся к высокому
уровню в ряде областей, которые не только не нужны, но и наносят ущерб их
способности предоставлять <<возможности>>, которые действительно нужны
заказчику. Вот почему ваша зрелая модель должна быть реализована таким образом,
чтобы она соответствовала результатам и ожиданиям заказчиков.

Одним из таких примеров являются те меры, которые повышают доступность услуг,
такие как возможность поддержки и сопряжения. Даже при отсутствии зрелой модели
показатели доступности часто не соответствуют тому, что на самом деле нужно
клиенту. У меня есть команды, которые напрягаются, чтобы соответствовать
какому-то мифическому показателю безотказной работы в 99,999%, не понимая, что
клиентам нужно, чтобы услуги работали только в течение предсказуемого периода в
течение рабочего дня. Клиентов, как правило, не волнует, доступна ли услуга,
когда нет никаких шансов, что им понадобится ею воспользоваться. На самом деле,
они, скорее всего, предпочли бы гораздо более простой и дешевый сервис, который
доступен, когда им это нужно, а не опасно перегруженный и всегда доступный
сервис, который является дорогим и медленно адаптируется к их потребностям.

Чтобы избежать подобных проблем, я стараюсь поощрять команды --- не
рассматривать показатели зрелости как оценку, а вместо этого использовать их в
качестве руководства, помогающего повысить их ситуационную осведомленность об
экосистеме предоставления услуг для удовлетворения потребностей их организации и
...
помощь. Иногда командам требуется руководство или целенаправленная экспертная
помощь, такая как ведущий специалист по техническому обслуживанию, о котором
...
неудаче разработки. Поскольку вы можете подсчитать только то, что было
...
## Уровни зрелой модели предоставления услуг
...
управления неполадок в экосистеме предоставления услуг.

Вот общая схема каждого из уровней:
* **Уровень 0**
 
Начальная точка предварительных данных. Это временное обозначение, с которого
все начинают в самом начале внедрения модели до того, как будут зафиксированы
какие-либо детали. На уровне 0 объясняется зрелая модель и составляется план по
выяснению и фиксации уровня для каждой интересующей области возможностей.
Нередко команда сразу же переходит на уровень 2 или 3 с этого обозначения.
* **Уровень 1**

Появление лучшей практики. Это тот случай, когда информация по интересующей
области возможностей была собрана и признана незрелой или находящейся в плохом
состоянии. На этом уровне необходимо разработать план <<Оздоровления>> с
графиком и ответственными лицами за каждое действие, чтобы помочь внедрить
улучшения и довести область, по крайней мере, до уровня 2.
* **Уровень 2**

Локальный или компонентный уровень зрелости. Это уровень, которого команда
достигает, когда она знает состояние интересующей ее области возможностей на
локальном или компонентном уровне. Они могут отслеживать ее состояние, понимать,
какие возможности клиента она обеспечивает или на что влияет, понимать, как
контролируется состояние и производительность, и понимать, что может пойти не
так. Существует набор практических методов управления деятельностью вокруг
потенциала, которые команда приняла и может постоянно совершенствовать.
Информация и координация за пределами местного уровня ограничены или
недостаточно развиты.
* **Уровень 3**

Межкомпонентный продолжительный процесс. На этом уровне команда имеет твердое
понимание того, от каких компонентов, услуг, элементов данных и команд зависят
компоненты и услуги, которые они предоставляют, что отслеживается и
поддерживается в актуальном состоянии. Существует очевидный хороший набор
...
эскалация известны и согласованы, чтобы смягчить любые проблемы координации во
время напряженной работы.
* **Уровень 4**

Продолжительный процесс межпутевого взаимодействия. На этом уровне все значимые
планы на обслуживание, которые включают компоненты и сервисы команды
...
потоки , документируются и понимаются типы отказов, а также их влияние на
клиента и желаемые результаты --- известны, документированы и наглядно
продемонстрированы способы устранения неполадок, ремонта и эскалации. Связь и
координация с командами на протяжении всего пути обслуживания являются четкими и
регулярными. Имеются инструменты, позволяющие фиксировать, понимать и улучшать
опыт обслуживания клиентов и модели использования на протяжении всего пути.
Команды часто сами помогают друг другу, привлекая других участников бизнеса для
помощи и инвестиций в слабые области, которые могут не входить в их
непосредственную компетенцию. Этот уровень необходим для бесперебойного
предоставления услуг в экосистемах с несколькими командами по предоставлению
услуг или зависимыми внешними службами.
* **Уровень 5**

Постоянная оптимизация процесса предоставления услуг. Когда команды доставки
достигают этого уровня, все работает безупречно. Команда доставки может и делает
релизы по требованию в тесном взаимодействии с другими командами и клиентом,
когда это необходимо. Непрерывные меры по улучшению повсюду, и команда регулярно
бросает вызов бизнесу, чтобы улучшить и принять новые задачи, которые активно
помогают текущим клиентам и привлекают новых клиентов для достижения их целевых
результатов с помощью предоставляемых услуг.

Зрелость обычно измеряется по нескольким параметрам, как показано на рисунке
9.1. Измерение различных измерений или областей, представляющих интерес, а не
просто один показатель зрелости --- отличный способ помочь командам выявить
...
[![11af8b0cb9777e8e79.jpg](https://ic.wampi.ru/2023/04/14/11af8b0cb9777e8e79.jpg)](https://wampi.ru/image/Rtf3DXt)

**Рисунок 9.1**

Диаграмма <<паука>> зрелости, представляющая текущее и целевое состояния

Особенностью этой модели является то, что каждый уровень зрелости является
последовательно накаплеваемым. Хотя между уровнями зрелости можно перемещаться
вверх и вниз, в основном это происходит за счет повышения уровня зрелости
благодаря лучшему пониманию того, что вы имеете, или за счет реального внедрения
улучшений, или за счет снижения уровня зрелости при внедрении новых компонентов,
решений или команд в экосистему услуг.

Еще одним преимуществом данного подхода является то, что он обеспечивает тонкий,
но эффективный толчок для улучшения коммуникационного потока и сотрудничества
между командами и даже другими важными сторонами за пределами организации. Это
может стать полезным стимулом для более замкнутых или враждующих команд. Это
также может выявить нездоровые отношения с поставщиками или, как в случае с
FastCo, описанном в главе 8, проблемное несоответствие уровня услуг поставщика,
которое необходимо устранить.

Чтобы собрать все это воедино, команда обычно работает с руководителем или
знающим человеком извне для сбора, анализа и отслеживания доказательств, лежащих
в основе каждого показателя возможностей. Это позволяет время от времени
проводить аудит данных, особенно в том случае, если произойдет событие, которое
не соответствует уровню зрелости. Это может помочь команде понять первопричину,
которая привела к снижению уровня зрелости. Я часто рекомендую командам строить
диаграммы, как показано на рисунке 9.1, чтобы отслеживать, на каком этапе они
находятся, а также то, чего они намерены достичь в следующем цикле
совершенствования.

Следует отметить, что, как правило, редко команды уверенно достигают уровня 5 по
всем показателям. Уровень 5 --- это сложно. Он означает, что все просто
работает. Экосистемы предоставления услуг редко бывают настолько статичными, что
больше нет необходимости устранять возникающие проблемы и улучшать их. Даже на
5-м уровне цель состоит в том, чтобы каждый постоянно находил новые способы
более эффективного достижения целевых результатов совместными усилиями.

## Области зрелого предоставления услуг, представляющие интерес
Теперь, когда у вас есть представление о работоспособном механизме измерения,
стоит обсудить аспекты того, что, вероятно, имеет смысл измерять и отслеживать в
вашей экосистеме.

Все экосистемы разные. Однако есть ряд общих полезных областей, на которые
следует обратить внимание для измерения зрелости предоставления услуг. Гигиена
на уровне программного обеспечения, данных и систем, безусловно, является одной
из них, как и то, как команда подходит к различным архитектурным практикам,
таким как сопряжение, избыточность и проблемы управления отказами. Все это ---
...
Есть и другие области, которые менее очевидны, но оказывают важное влияние на
осведомленность команды по предоставлению услуг и ее способность эффективно
...
- Управление конфигурацией и гигиена доставки

- Поддерживаемость

- Смягчение последствий единой точки отказа (SPoF) и управление связью
...
Знание того, насколько хорошо поступают данные, имеет большое значение.
...
поддерживающих создание, доставку и эксплуатацию кода и услуг.
...
- Каков баланс проактивных и реактивных инструментов, помогающих нужным людям
  узнать о разработке, требующей внимания. Сколько из этих мер обязательно
  являются реактивными, и почему нет разумных проактивных альтернатив?

- Насколько велики возможные временные задержки между появлением события и тем,
  как нужные люди узнают о нем?
...
- Насколько известны сильные и слабые стороны команды и службы?
...
поставщиков. Возникающие в результате дросселирование, отключение услуг и сбитые
бюджеты доставляют неудобства и могут негативно повлиять на клиента.
...
сборки/интеграции/тестирования, версионности, атомарности упаковки, отслеживания
...
## Управление конфигурацией и гигиена поставок

Гигиена имеет большое значение в вашей экосистеме доставки.
...
То же самое происходит и в экосистемах доставки. Как и при приготовлении еды,
любой недостающий или поврежденный элемент, неправильная версия или тип,
...
сборки и доставки, будут способствовать улучшению возможностей клиента.
...
- Как команда доставки управляет своим кодом и средой доставки? Делается ли это
  более зрелым способом с хорошим контролем версий, атомарной упаковкой и
...
- Ведет ли команда разработчиков разработку по принципу top-of-trunk, когда весь
  ...
  слияния можно легко упустить детали осознания.

- Упаковано ли программное обеспечение, и если да, то являются ли пакеты
  атомарными, чтобы их можно было легко удалить, не оставляя остатков в виде
  висячих файлов, осиротевших резервных копий или потенциально искаженных
  конфигураций?
...
- Известна ли, отслеживается и управляется ли совместимость версий между
...
Хорошее управление конфигурацией и гигиена доставки --- это то, что позволяет
инструментам и механизмам непрерывной доставки по-настоящему сиять. По этой
причине это тот показатель возможностей, который может быть наиболее эффективно
использован дополнительными операционными инструментами и механизмами.
...
- Возможности, встроенные в компонент и экосистему, в которой живет услуга,
...
Возможность поддержки --- это часто неправильно понимаемая и игнорируемая
...
обработке инцидентов. Я регулярно сталкиваюсь с рунбуками, которые ожидают, что
их пошаговые процессы будут бездумно выполняться для устранения проблемы, вместо
того, чтобы поощрять сотрудников к пониманию проблемы, чтобы они могли найти
способы проактивного снижения вероятности возникновения таких проблем в будущем.
На другом конце спектра находятся планы аварийного восстановления и обеспечения
непрерывности бизнеса, которые пытаются заранее спланировать шаги по преодолению
конкретных катастрофических бедствий. Хотя документирование подходов к
устранению возможных проблем и выполнению процедур восстановления и обеспечения
непрерывности бизнеса является разумным, рассчитывать на то, что все пути выхода
из строя и восстановления будут задокументированы таким образом, что их сможет
выполнить любой технический специалист, независимо от глубины его знаний
экосистемы, в которой он работает, зачастую опасно. Мало того, что маловероятно,
что все пути будут зафиксированы, они часто не учитывают непредвиденную
комбинацию событий, таких как деградация нескольких компонентов или событие
повреждения данных, которые происходят с большей вероятностью и требуют
глубокого знания экосистемы для решения проблемы.

Каждый, кто провел несколько лет в своей карьере, вероятно, был застигнут
врасплох каскадом, казалось бы, незначительных проблем, которые снежным комом
переросли в катастрофу. Некоторые из них, такие как ошибка BGP в Facebook/Meta в
октябре 2021 года[^1], отказ электропитания в дата-центре 365 Main в 2007
году[^2], или отказ Azure в феврале 2012 года[^3], были достаточно масштабными,
чтобы встряхнуть тысячи пострадавших клиентов от их катастрофически пассивной
зависимости от плохо понятых зависимостей. Однако не обязательно быть крупным
поставщиком услуг, чтобы попасть в такую ловушку. Я лично был свидетелем сотен
менее известных, но не менее разрушительных каскадов отказов, многие из которых,
как меня неоднократно убеждали заранее, никогда не произойдут. Поощряя
сотрудников к пониманию экосистемы услуг и результатов, которые она пытается
достичь, вы можете значительно сократить потенциальную продолжительность сбоя и
...
Существует несколько хороших способов отслеживания возможности поддержки. Начать
...
как установить сервис, но и как установить сервер в стойку и подключить его к
сети, установить на него нужную операционную систему и определить все остальные
детали конфигурации и поддержки. Это был впечатляюще эффективный способ улучшить
...
Подобные упражнения легко проводить при предоставлении услуг в облаке, в том
числе проводя код через конвейер доставки или пытаясь определить, как запустить
новые экземпляры услуг. Я знаю, что некоторые компании делают это, заставляя
новых сотрудников выполнять push в продакшн в рамках процесса адаптации, чтобы
помочь им ознакомиться с процессами доставки и push, а также получить
...
поощрить всех к открытому обмену информацией и сотрудничеству через границы
команды.
...
- Совпадают ли определенные инциденты с изменениями? Это может указывать на
  проблему ситуационной осведомленности в вашей экосистеме доставки, которую
