...
> ситуации, в темпе, который позволяет сформировать ситуацию или среагировать на
> изменения и выполнить миссию
>
...
необходимое для достижения целевого результата. 

Наконец, такие подходы не   
...
домена вашей действующей экосистемы. Как мы рассмотрим в главе 5, <<Риск>>, не 
все экосистемы упорядочены и предсказуемы.  
...
Децентрализация командования имеет ряд 
...
На самом деле это гораздо сложнее, чем может показаться.   
...
Чтобы хорошо работать, децентрализованному командованию нужно нечто большее, 
чем просто
...
может помочь создать ощущение <<единства>>, особенно когда те, кто выполняет 
эту роль,
