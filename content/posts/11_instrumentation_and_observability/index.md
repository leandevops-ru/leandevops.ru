...
Рисунок 11.1. Хотя они собрали его, Билл не знал, откуда оно и зачем нужно.
...
Рисунок 11.2 Как узнать, соответствует ли опыт требованиям вашего клиента?
...
Рисунок 11.3. <<Как обеспечить хорошие результаты для пациентов?>>
...
## Знание аудитории
Рисунок 11.4 Знание аудитории может предотвратить неловкость и неудачи. 
...
Рисунок 11.5 <<Мы работаем в песочнице?>>
...
gemba" с начала процесса доставки и не проходят до конца. Вместо этого они
начинают с последнего шага и идут в обратном порядке через жизненный цикл до
начала.

Фигура 11.8 Прохождение по Гемба задом наперёд
